...
import { requestOTP, verifyOTPController, refreshTokenController, logoutController } from './controllers/authController';
import { getMe } from '../user/controllers/userController';
...
/** GET /auth/me — alias vers GET /me (compat front). Préférer GET /api/v1/me. */
